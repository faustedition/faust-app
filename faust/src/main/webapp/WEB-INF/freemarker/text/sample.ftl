<@faust.page title="Text">
	...
	<p class="center secondary-color">Mephist. <span class="small-caps primary-color">(als Aufseher, voran)</span></p>
	...
	<p class="center secondary-color">Lemuren <span class="small-caps primary-color">im Chor</span></p>
	...
	<p class="center secondary-color">Mephisto.</p>
	...
	<p class="center secondary-color">Lemuren. <span class="small-caps primary-color">(mit neckischen Gebärden grabend)</span></p>
	...
	<p class="center secondary-color">Faust. <span class="small-caps primary-color">(aus dem Pallaste tretend, tastet an den Thürpfosten)</span></p>
	...
	<p class="center secondary-color">Faust.</p>

	<p>Aufseher!</p>

	<p class="center secondary-color">Mephist.</p>
	...
	<p class="center secondary-color">Mephist. <span class="small-caps primary-color">(halblaut)</span></p>
	...
	<p class="center secondary-color">(Faust <span class="small-caps primary-color">sinkt zurück, die <span class="normal-variant secondary-color">Lemuren</span> fassen ihn auf und legen ihn auf den Boden)</span>.</p>
	...
	<p class="center secondary-color">Chor.</p>

	<p>Steht still! Sie schweigt wie Mitternacht.<br />
	Der Zeiger fällt.</p>

	<p class="center secondary-color">Meph.</p>
