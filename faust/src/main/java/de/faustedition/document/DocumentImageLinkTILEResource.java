...
public class DocumentImageLinkTILEResource extends ServerResource {
	...
	@Inject
	public DocumentImageLinkTILEResource(TemplateRepresentationFactory viewFactory,
	...
	public Representation overview() throws IOException {
		...
		return viewFactory.create("document/imagelink-tile", getRequest().getClientInfo(), viewModel);
