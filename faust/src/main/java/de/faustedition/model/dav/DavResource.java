...
public abstract class DavResource implements Resource, GetableResource, PropFindableResource, LockableResource {

	protected final DavResourceFactory factory;

	protected DavResource(DavResourceFactory factory) {
