...
public class EncodedTextDocumentManager {
	...
	@PostConstruct
	public void init() {
		defaultProcessors = Lists.newArrayList(new ProcessingInstructionProcessor(), new NamespaceDeclarationProcessor(),
				new HeaderTemplateProcessor(), new HandDeclarationProcessor(), new CharacterDeclarationProcessor());
	}
