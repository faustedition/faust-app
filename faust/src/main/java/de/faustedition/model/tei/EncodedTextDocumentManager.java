...
import static de.faustedition.model.xml.XmlUtil.documentBuilder;
...
public class EncodedTextDocumentManager {
	...
	private static final Resource HEADER_TEMPLATE_RESOURCE = new ClassPathResource("/tei/header-template.xml");
	private static final Resource HAND_NOTES_RESOURCE = new ClassPathResource("/tei/hand-notes.xml");
	private static final Resource CHAR_DECL_RESOURCE = new ClassPathResource("/tei/character-declarations.xml");
