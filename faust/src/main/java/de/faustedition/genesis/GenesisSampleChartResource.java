...
public class GenesisSampleChartResource extends ServerResource {
    ...
    static class GenesisExampleChart extends AbstractXYDataset implements IntervalXYDataset {
        private boolean transposed;

        public void render(OutputStream imageStream, PrintWriter imageMapWriter, final String manuscriptBaseUrl, String mapId)
                throws IOException {
            JFreeChart chart = ChartFactory.createXYBarChart(null, "Handschrift", false, "Vers", this, PlotOrientation.HORIZONTAL,
                    false, false, false);
