...
public class GenesisSampleResource extends ServerResource {
	...
	static final List<String> WITNESSES = Lists.newArrayList("V.H15", "V.H13v", "V.H14", "V.H18", "V.H17r", "V.H2", "V.H16",
			"V.H");
	...
	static {
		...
		GENESIS_DATASET.put("V.H13v",
				new LineInterval[] { new LineInterval("faust/2.5/gsa_391027.xml", "3", 11511, 11530) });
		...
		GENESIS_DATASET.put("V.H17r",
				new LineInterval[] { new LineInterval("faust/2.5/gsa_391510.xml", "1", 11593, 11595) });
