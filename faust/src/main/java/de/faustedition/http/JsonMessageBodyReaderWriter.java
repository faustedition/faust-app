...
public class JsonMessageBodyReaderWriter extends AbstractMessageReaderWriterProvider<Object> {

    private final ObjectMapper objectMapper;

    @Inject
    public JsonMessageBodyReaderWriter(ObjectMapper objectMapper) {
